...
class SortModel {
    ...
    private val _itemSelected = MutableLiveData(R.string.catalog_product_sort_popular)
    ...
    fun apply() {
        ...
        _itemSelected.value = when(true) {
            popular.value!! -> R.string.catalog_product_sort_popular
            cheaper.value!! -> R.string.catalog_product_sort_cheaper
            expensive.value!! -> R.string.catalog_product_sort_expensive
            stock.value!! -> R.string.catalog_product_sort_stock
            discount.value!! -> R.string.catalog_product_sort_discount
