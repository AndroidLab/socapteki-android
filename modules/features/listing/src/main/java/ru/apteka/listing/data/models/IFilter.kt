...
sealed interface IFilter {
    ...
    data class FilterPriceModel(
        ...
        override val isChanged: LiveData<Boolean> = _isChanged
        ...
        fun onChange() {
            if (selectedMinProgress.value!! != _selectedMinPrice || selectedMaxProgress.value!! != _selectedMaxPrice) {
                Log.d("myL", "onChange")
    ...
    data class FilterAllModel(
        ...
        override val enabled = MediatorLiveData(true).apply {
